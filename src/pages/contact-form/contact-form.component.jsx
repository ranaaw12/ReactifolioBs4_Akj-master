      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="ranaawais3553@gmail.com" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://web.facebook.com/rana.owais.3705/" target="_blank" rel="noopener noreferrer">
